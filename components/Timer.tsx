...
const Timer: React.FC<TimerProps> = ({ settings, pomodoros, onSettingsChange, onPomodorosChange }) => {
  ...
  return (
    <div className="p-6 rounded-lg shadow-lg border border-jam-border dark:border-slate-700 bg-jam-light-gray/80 dark:bg-slate-800/50 backdrop-blur-sm relative">
