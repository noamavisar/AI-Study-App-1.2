      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="flex space-x-2">
            <form onSubmit={handleAddNewProject} className="flex-grow flex space-x-2">
                <input
                type="text"
                ...
                <button 
                    type="submit" 
                    className="px-4 py-2 text-sm font-medium text-white bg-jam-dark rounded-lg hover:bg-black dark:bg-pink-600 dark:hover:bg-pink-700"
                >
                Add
                </button>
            </form>
